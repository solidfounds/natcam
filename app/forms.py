...
class PrimerRegistroFORM(ModelForm):
    class Meta:
        ...
        fields = ('nombre', 'apellidos', 'calle','numero','colonia_fraccionamiento','municipio_delegacion','endidad','cp', 'nss','telefono','empresa','registro_patronal','comision','ife','numero_de_cuenta','banco')
